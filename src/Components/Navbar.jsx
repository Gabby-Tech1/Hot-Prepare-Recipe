            ...
            {mobileDrawerOpen && (
                <div className="fixed right-0 z-20 w-full p-12 flex flex-col justify-center items-center lg:hidden bg-orange-200 bg-opacity-70">
                    <ul className='font-semibold text-lg'>
                        <li className=' hover:text-orange-500 duration-300 ease-in py-3 text-center'><a href="#">Home</a></li> <hr className='w-60'/>
                        <li className=' hover:text-orange-500 duration-300 ease-in py-3 text-center'><a href="#">Recipes</a></li> <hr className='w-60'/>
                        <li className=' hover:text-orange-500 duration-300 ease-in py-3 text-center'><a href="#">Blogs</a></li> <hr className='w-60'/>
                        <li className=' hover:text-orange-500 duration-300 ease-in py-3 text-center'><a href="#">About Us</a></li> <hr className='w-60'/>
                    </ul>
