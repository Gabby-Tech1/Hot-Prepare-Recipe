    ...
    <div className='mb-12 lg:mb-0' id='hero'>
        <div className='lg:h-[90vh] flex items-center justify-between flex-col-reverse lg:flex-row px-8 lg:px-16 gap-12'>
            <div className='flex flex-col gap-6'>
                ...
                <p className='text-gray-600 italic font-medium'>Dive into our treasury of delectable recipes crafted with passion and care. From comforting classics to innovative delights, each dish promises a symphony of taste that will tantalize your senses and warm your heart. Join us as we embark on a culinary adventure where every recipe tells a story and every bite is a celebration of life's delicious moments. Let's create magic in the kitchen together and savor the joy of cooking!
